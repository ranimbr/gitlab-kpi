/**
 * components/common/ConfirmModal.jsx — inchangé fonctionnellement.
 */
export default function ConfirmModal({
  show=false, title="Confirmer", message="Voulez-vous continuer ?",
  confirmLabel="Confirmer", confirmColor="danger",
  icon="ri-error-warning-line", iconColor="danger",
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content border-0 shadow">
          ...
          <div className="modal-footer border-0 justify-content-center gap-2 pt-0">
            <button className="btn btn-light px-4" onClick={onClose} disabled={loading}>Annuler</button>
            <button className={`btn btn-${confirmColor} px-4`} onClick={onConfirm} disabled={loading}>
              {loading
